...
public abstract class BaseBlockLootTables extends BlockLoot {
    ...
    @Override
    protected void add(@Nonnull Block block, @Nonnull Builder table) {
    ...
    protected static Builder createOreDrop(Block block, ItemLike item) {
        return createSilkTouchDispatchTable(block, applyExplosionDecay(block, LootItem.lootTableItem(item.asItem())
              .apply(ApplyBonusCount.addOreBonusCount(Enchantments.BLOCK_FORTUNE))
        ));
    }

    protected static Builder droppingWithFortuneOrRandomly(Block block, ItemLike item, UniformGenerator range) {
        return createSilkTouchDispatchTable(block, applyExplosionDecay(block, LootItem.lootTableItem(item.asItem())
     ...
     */
    @Nonnull
    protected static Builder createSlabItemTable(Block slab) {
     ...
     */
    @Nonnull
    protected static Builder createSingleItemTable(ItemLike item) {
     ...
     */
    @Nonnull
    protected static Builder createSingleItemTableWithSilkTouch(@Nonnull Block block, @Nonnull ItemLike item, @Nonnull NumberProvider range) {
     ...
     */
    @Nonnull
    protected static Builder createSilkTouchDispatchTable(@Nonnull Block block, @Nonnull LootPoolEntryContainer.Builder<?> builder) {
     ...
     */
    @Nonnull
    protected static Builder createSelfDropDispatchTable(@Nonnull Block block, @Nonnull LootItemCondition.Builder conditionBuilder,
