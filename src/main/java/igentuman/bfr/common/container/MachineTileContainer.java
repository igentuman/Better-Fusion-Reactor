...
public class MachineTileContainer<TILE extends TileEntityMekanism> extends MekanismTileContainer<TILE> {
    ...
    public MachineTileContainer(ContainerTypeRegistryObject<?> type, int id, Inventory inv, @NotNull TILE tile) {
