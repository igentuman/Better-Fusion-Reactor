...
public class GuiFusionReactorLogicAdapterInput extends GuiMekanismTile<TileEntityFusionReactorLogicAdapter, EmptyTileContainer<TileEntityFusionReactorLogicAdapter>> {
    ...
    protected void addGuiElements() {
        ...
        for (int i = 0; i < DISPLAY_COUNT; i++) {
            int typeShift = 22 * i;
            addRenderableWidget(new ReactorLogicButton<>(this, 17, 32 + typeShift, i, tile, TileEntityFusionReactorLogicAdapter.FusionReactorLogic.class, scrollBar::getCurrentSelection, tile::getInputModes, this::changeLogic));
        }
    }
