...
public class GuiHeatBar  extends GuiElement {
    ...
    private final GuiHeatBar.IPowerInfoHandler handler;
    private final int xLocation;
    private final int yLocation;
    private final int width = 6;
    private final int height = 56;

    public GuiHeatBar(IGuiWrapper gui, IStrictEnergyStorage tile, ResourceLocation def, int x, int y) {

        super(new ResourceLocation("bfr", MekanismUtils.ResourceType.GUI_ELEMENT.getPrefix() + "GuiHeatBar.png"), gui, def);
        this.tileEntity = tile;
        this.handler = new GuiHeatBar.IPowerInfoHandler() {
            public String getTooltip() {
                return MekanismUtils.getEnergyDisplay(GuiHeatBar.this.tileEntity.getEnergy(), GuiHeatBar.this.tileEntity.getMaxEnergy());
            }

            public double getLevel() {
                return GuiHeatBar.this.tileEntity.getEnergy() / GuiHeatBar.this.tileEntity.getMaxEnergy();
            }
        };
        this.xLocation = x;
        this.yLocation = y;
    ...
    public GuiHeatBar(IGuiWrapper gui, GuiHeatBar.IPowerInfoHandler h, ResourceLocation def, int x, int y) {
        super(new ResourceLocation("bfr", MekanismUtils.ResourceType.GUI_ELEMENT.getPrefix() + "GuiHeatBar.png"), gui, def);
